...
if __name__ == "__main__":
    input_dir = r'C:\Users\RIzan\Documents\dfd\dataset\test'  # Adjust this path to your DFDC test dataset
    output_dir = r'C:\Users\RIzan\Documents\dfd\dataset\test_processed'  # Adjust this path to where you want to save processed data
    preprocess_dfdc_data(input_dir, output_dir, frame_rate=1, log_file='test_processed_videos.json')
